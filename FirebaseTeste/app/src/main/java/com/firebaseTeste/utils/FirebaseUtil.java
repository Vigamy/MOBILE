package com.firebaseTeste.utils;
...
public class FirebaseUtil {
    ...
    public static CollectionReference getChatroomMessageReference(String chatroomId) {
        return getChatroomReference(chatroomId).collection("chatrooms");
    }

    public static String getCharoomId(String userId1, String userId2) {
