...
public class Formulario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("pessoa")) {
            ...
            this.pessoaAlterar = (Pessoa) bundle.getSerializable("pessoa");
            txtNome.setText(pessoaAlterar.getNome());
            txtResponsavel.setText(pessoaAlterar.getResponsavel());
            txtFone.setText(pessoaAlterar.getFone());
            txtDtnasc.setText(dtf.format(pessoaAlterar.getDtNasc()));
            txtRestricao.setChecked(pessoaAlterar.isRestricoes());
        }
    }
}